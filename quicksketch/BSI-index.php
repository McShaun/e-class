...
$page = 'Name'; 
?>
<?php include("../1st-lesson/inc/header.php"); ?>
<body>
<!--
...
<form action="../1st-lesson/lesson1.php" method="post" id="commentForm">

<div id="left-or-top">
  <center>
	<img src="../1st-lesson/form_avatar.png" style="margin-left:-5px;">
    </center>
</div>
...
<?php include("../1st-lesson/inc/google-analytics.php") ; ?>
</body>
</html>
